...
var offersLink        = 'http://www.telegraph.co.uk/promotions/';
var datingLink        = 'http://dating.telegraph.co.uk/';
var jobsLink          = 'https://jobs.telegraph.co.uk/';
var shopLink          = 'http://shop.telegraph.co.uk/?utm_source=tmg&utm_medium=nav&utm_campaign=commercial';
var puzzlesLink       = 'http://puzzles.telegraph.co.uk/site/index.php?utm_source=tmg&utm_medium=nav&utm_campaign=commercial';

//check country code existence in a meta-tag
function isGeoCountry(country,metaTag) {
    var geoCountry=$("meta[content][name='"+metaTag+"']");
    if(geoCountry) {
        geoCountry = geoCountry.attr("content");
    }
    
    return country===geoCountry;
}

var countryGB = "GB";
var isCountryGB = isGeoCountry(countryGB,"tmgads.geo") || isGeoCountry(countryGB,"DCSext.akamigeo");

if(!isCountryGB) {
    samSubscribeLink = 'http://www.telegraph.co.uk/subscriptions/international/';
}
	...
	if (samPageUser.getLoggedIn() == true || samPageUser.getLoggedIn() == "true") {
		...
		if (samPageUser.getWall() === true && samPageUser.getLoggedIn() !== true) {
			...
			if (typeof(menuDisabled) === 'boolean' && menuDisabled === true || gup('wall') === 'true' || gup('disabled') === 'true' || samPageUser.getWall() === true) {
				$(".tmgMainMenu").html("<span class='menuButtonCon'><a href='" + tmgHomeUrl + "' title='The Telegraph Home'><img src='" + samAssets + "/toolbar/images/" + samLoggedInLogo + ".png' name='" + samLoggedInLogo + "' alt='" + samLoggedInLogo + "' class='tmgMainMenuLogo'/></a><span id='" + samPrivacyPolicyMenu.getMenuId() + "' class='menuButtonTelegraphArea noArrow' title='read our privacy and cookies policy'>" + samPrivacyPolicyMenu.getMenuName() + 
				"<span class='dLine'></span></span><span id='" + samJobsMenu.getMenuId() + "' class='menuButtonTelegraphArea noArrow' title='Telegraph Jobs'>" + samJobsMenu.getMenuName() + 
				"<span class='dLine'></span></span><span id='" + samDatingMenu.getMenuId() + "' class='menuButtonTelegraphArea noArrow' title='Telegraph Dating'>" + samDatingMenu.getMenuName() + 
				"<span class='dLine'></span></span><span id='" + samOffersMenu.getMenuId() + "' class='menuButtonTelegraphArea noArrow' title='Telegraph Offers'>" + samOffersMenu.getMenuName() + 
				"<span class='dLine'></span></span><span id='" + samShopMenu.getMenuId() + "' class='menuButtonTelegraphArea noArrow' title='Telegraph Shop'>" + samShopMenu.getMenuName() + 
				"<span class='dLine'></span></span><span id='" + samPuzzlesMenu.getMenuId() + "' class='menuButtonTelegraphArea noArrow' title='Telegraph Puzzles'>" + samPuzzlesMenu.getMenuName() + 
				"<span class='dLine'></span></span> </span></span></div>");
			} else {
				$(".tmgMainMenu").html("<span class='menuButtonCon'><a href='" + tmgHomeUrl + "' title='The Telegraph Home'><img src='" + samAssets + "/toolbar/images/" + samLoggedInLogo + ".png' name='" + samLoggedInLogo + "' alt='" + samLoggedInLogo + "' class='tmgMainMenuLogo'/></a><span id='" + samPrivacyPolicyMenu.getMenuId() + "' class='menuButtonTelegraphArea noArrow' title='read our privacy and cookies policy'>" + samPrivacyPolicyMenu.getMenuName() + 
				"<span class='dLine'></span></span><span id='" + samJobsMenu.getMenuId() + "' class='menuButtonTelegraphArea noArrow' title='Telegraph Jobs'>" + samJobsMenu.getMenuName() + 
				"<span class='dLine'></span></span><span id='" + samDatingMenu.getMenuId() + "' class='menuButtonTelegraphArea noArrow' title='Telegraph Dating'>" + samDatingMenu.getMenuName() + 
				...
				"<span class='dLine'></span></span><span id='" + samShopMenu.getMenuId() + "' class='menuButtonTelegraphArea noArrow' title='Telegraph Shop'>" + samShopMenu.getMenuName() + 
				"<span class='dLine'></span></span><span id='" + samPuzzlesMenu.getMenuId() + "' class='menuButtonTelegraphArea noArrow' title='Telegraph Puzzles'>" + samPuzzlesMenu.getMenuName() + 
				"<span class='dLine'></span></span> <span class='menuButton noArrow userName' id='" + samSitesMenu.getMenuId() + "'><span class='dLine'></span>" + samSitesMenu.getMenuName() + 
				"</span></span>" + samSubMessage + "<span class='menuButton noArrow' id='samLogOutButton'>Log out<span class='dLine'></span></span></span></div>");
			}
		}
	} else {
		if (samPageUser.getWall() === true && samPageUser.getLoggedIn() !== true) {
			...
			// loadWall();
				...
				$("#tmgMenu-z1").html("<div id='tmgMenuBar-z1'><div class='tmgMainMenu'><span class='menuButtonCon'><a href='" + tmgHomeUrl + "' title='The Telegraph Home'><img src='" + samAssets + "/toolbar/images/" + samLoggedOutLogo + ".png' name='" + samLoggedOutLogo + "' alt='" + samLoggedOutLogo + "' class='tmgMainMenuLogo'/></a></span><span id='" + samPrivacyPolicyMenu.getMenuId() + "' class='menuButtonTelegraphArea noArrow' title='read our privacy and cookies policy'>" + samPrivacyPolicyMenu.getMenuName() + 
				"<span class='dLine'></span></span><span id='" + samJobsMenu.getMenuId() + "' class='menuButtonTelegraphArea noArrow' title='Telegraph Jobs'>" + samJobsMenu.getMenuName() + 
				"<span class='dLine'></span></span><span id='" + samDatingMenu.getMenuId() + "' class='menuButtonTelegraphArea noArrow' title='Telegraph Dating'>" + samDatingMenu.getMenuName() + 
				"<span class='dLine'></span></span><span id='" + samOffersMenu.getMenuId() + "' class='menuButtonTelegraphArea noArrow' title='Telegraph Offers'>" + samOffersMenu.getMenuName() + 
				"<span class='dLine'></span></span><span id='" + samShopMenu.getMenuId() + "' class='menuButtonTelegraphArea noArrow' title='Telegraph Shop'>" + samShopMenu.getMenuName() +
				"<span class='dLine'></span></span><span id='" + samPuzzlesMenu.getMenuId() + "' class='menuButtonTelegraphArea noArrow' title='Telegraph Puzzles'>" + samPuzzlesMenu.getMenuName() +
				"<span class='dLine'></span></span> <span class='menuButton noArrow' id='" + samSubscribeMenu.getMenuId() + "'>" + samSubscribeMenu.getMenuName() + 
...
samOffersMenu = new Menu({dropDown: false});
samDatingMenu = new Menu({dropDown: false});
samJobsMenu   = new Menu({dropDown: false});
samShopMenu   = new Menu({dropDown: false});
samPuzzlesMenu= new Menu({dropDown: false});
...
if (typeof (plink) == "undefined") {
	...
	// set up offers button
	samOffersMenu.setMenuName("Offers");
	samOffersMenu.setMenuId("offersButton");
	samOffersMenu.setMenuClass("hiddenDrop");

	// set up dating button
	samDatingMenu.setMenuName("Dating");
	samDatingMenu.setMenuId("datingButton");
	samDatingMenu.setMenuClass("hiddenDrop");
	
	// set up jobs button
	samJobsMenu.setMenuName("Jobs");
	samJobsMenu.setMenuId("jobsButton");
	samJobsMenu.setMenuClass("hiddenDrop");
	
	// set up shop button
	samShopMenu.setMenuName("Shop");
	samShopMenu.setMenuId("shopButton");
	samShopMenu.setMenuClass("hiddenDrop");
	
	// set up puzzles button
	samPuzzlesMenu.setMenuName("Puzzles");
	samPuzzlesMenu.setMenuId("puzzlesButton");
	samPuzzlesMenu.setMenuClass("hiddenDrop");
...
$(document).ready(function() {
	...
	$("#offersButton").live('click', function () {
		window.location = "" + offersLink;
	});
	
	$("#datingButton").live('click', function () {
		window.location = "" + datingLink;
	});
	
	$("#jobsButton").live('click', function () {
		window.location = "" + jobsLink;
	});
	
	$("#shopButton").live('click', function () {
		window.location = "" + shopLink;
	});
	
	$("#puzzlesButton").live('click', function () {
		window.location = "" + puzzlesLink;
	});
