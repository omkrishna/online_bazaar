var flxpxlObj = (function() {
	...
	obj.execute = function() {
		...
		var conditions_320957 = {};
		setTimeout(function() {
		function pageGroup_320957() {
			obj.placeAppNexusSegmentScript('seg?add=1529458&t=1', null, null, null, 'None', '');
		}
		currentFunction=function(queryId){return (function(){queryId&&(conditions_320957[queryId]=true);if(checkConditions(conditions_320957)){pageGroup_320957();}});};
		if(
			(window.location.href != '')
		) {
			if(checkConditions(conditions_320957)){pageGroup_320957();}
		}
		}, 1);

		// Page group: Organic
		var conditions_320958 = {};
		setTimeout(function() {
		function pageGroup_320958() {
			obj.placeAppNexusSegmentScript('seg?add=1529459&t=1', null, null, null, 'Organic', '');
		}
		currentFunction=function(queryId){return (function(){queryId&&(conditions_320958[queryId]=true);if(checkConditions(conditions_320958)){pageGroup_320958();}});};
		if(
			(flxKeyword != '')
		) {
			if(checkConditions(conditions_320958)){pageGroup_320958();}
		}
		}, 1);
...
function flxSendKeyword(keyword) {
	if(keyword) {
		if(!keywordsSent[keyword]) {
			sendRequest('//ib.adnxs.com/getuid?https://dm6ndb2k9edja.cloudfront.net/k.gif?pubID=327775&' + '&keyword=' + encodeURIComponent(keyword) + '&AnId=$UID' + '&url=' + encodeURIComponent(window.location.href.split('#')[0].split('?')[0].substring(0,500)) + '&ref=' + encodeURIComponent(document.referrer.substring(0, 500)));
