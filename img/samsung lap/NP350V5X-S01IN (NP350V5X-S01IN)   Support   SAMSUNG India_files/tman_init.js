...
var arrSiteCode = new Array("ar", "au", "at", "be_fr", "be", "br", "ca_fr", "ca", "cl", "cn", "co", "cz", "de", "ee", "fi", "fr", "de", "gr", "hk_en", "hk", "hu", "in", "id", "iran", "ie", "il", "it", "jp", "kz_ru", "sec", "lv", "lt", "my", "mx", "nl", "nz", "no", "latin", "pe", "ph", "pl", "pt", "ru", "sa_en", "sg", "sk", "za", "es", "se", "ch_fr", "ch", "tw", "th", "tr", "us", "ae", "ua", "ua_ru", "vn", "uk", "global", "eu", "ro", "baltic","mea_ar","mea_en","n_africa","africa_en","ae_ar","bg","rs","hr","africa_fr","africa_pt","latin_en","ve","pk","levant","eg","sa");
...
try {
	for (var i=0; i<arrSiteCode.length; i++) {
		if (site_cd == arrSiteCode[i]) {
			...
			tagmanAcct = "samsung" + arrSiteCode[i];
			break;
		}
	}
} catch(e) {
