...
(function ($) {
	...
	ss.Sign = function () {
		...
		function findAccount() {
			...
			$("#returnURL", $findAccountForm).val( returnURL );
			$("#goBackURL", $findAccountForm).val( returnURL );
		...
		function signUp() {
			...
			$("#returnURL", $joinForm).val( returnURL );
			$("#goBackURL", $joinForm).val( returnURL );
			...
			if (!userData)
			{
				...
				else
				{
					function getUserInfo() {
						$.ajax({
							url : "/"  + SITE_CD + "/data-login/getUserProfile",
							type : "post",
							success: function(data){
								if (data.basicInfoModel)
								{
									userData = {
											'firstName' : data.basicInfoModel.firstName,
											'lastName'	: data.basicInfoModel.lastName,
											'emailID'	: data.basicInfoModel.emailID
									};
								}
								else
									userData = null;
