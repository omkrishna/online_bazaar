...
if (e9Manager === undefined || e9Manager.init === false)
   ...
   e9Manager = (
	...
	e9Manager = manager;
        ...
        var e9Page = 
	 {
	   ...
	   tagOptions: {"snackBar":{"serveSnackBar":false, "snackBarBorder":false, "snackBarBorderColor":"", "snackBarClose":false, "mobileOptimizedSite":false}},
...
else
 {
   if (e9 !== undefined) 
    {
      e9Manager.setSite("gsmarenacom","ros");
